...
public class FileAccess implements IFileAccess {
    ...
    private List<File> GetFileInfos(String startFolder, MediaTypes searchType) {
    ...
    public List<File> SearchFiles(String searchTerm, MediaTypes searchType) throws IOException {
    ...
    public List<File> GetAllFiles(MediaTypes searchType) {
